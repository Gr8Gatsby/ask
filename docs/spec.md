...
| 2026-03-31 | Git Repos script: replaced GitHub issues script with local git repository monitor. Scans ~ for all git repos, prioritizes unpushed commits, supports Push / Pull / Fetch / Discard Changes from iPhone. |
